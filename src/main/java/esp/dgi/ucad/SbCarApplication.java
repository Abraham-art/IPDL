...
private static final Logger logger = (Logger) LoggerFactory. getLogger(SbCarApplication .class );
...
class SbarController{
	@Value("${fullname:ABRAHAM}")
	private String fullname;

	@GetMapping
	String getFullname() {
	return "Modification effectuer par "+this.fullname+" !";
	}
}